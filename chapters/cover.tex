...
\title{Internal Representation Analysis for Improving Reliability, Control, and Training Efficiency in Large Language Models}
\titlerus{Анализ внутренних представлений для повышения надёжности, управляемости и эффективности обучения больших языковых моделей}
